package com.joebrooks.mapshotimageapi.processing.map.google;
...
class GoogleMapGeneratorControllerTest {
    ...
    void 구글_지도_가져오기() throws Exception {
        ...
        Map<String, String> fieldMap = objectMapper.convertValue(order, new TypeReference<Map<String, String>>() {});
